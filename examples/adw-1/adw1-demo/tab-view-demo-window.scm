...
(define-module (adw1-demo tab-view-demo-window)
  #:use-module (oop goops)
  #:use-module (g-golf)
  #:use-module (adw1-demo tab-view-demo-page)
...
(define (install-callbacks self) ;; tab-view-demo-window
  (let* ((display (get-display self))
    ...
    (connect view
             "page-detached"
             (lambda (view page)
               (page-detached-cb self view page)))
    (connect view
             "setup-menu"
             (lambda (view page)
...
(define (page-detached-cb tab-view-demo-window view page)
